  ...
  return (
    <div className="max-w-6xl mx-auto pb-12 print:m-0 print:p-0 print:max-w-none">
      <div className="mb-8 flex items-center justify-between print:hidden">
        ...
        <div className="bg-white p-8 border shadow-sm print:shadow-none print:border-none print:p-0 text-black font-serif md:block hidden">
        ...
        <div className="lg:hidden print:hidden bg-gray-50 p-6 rounded-lg border border-dashed text-center">
          <h2 className="text-lg font-bold text-gray-800">Return Form is Ready</h2>
          <p className="text-gray-600 mt-2">
            The printable return form is not displayed on small screens to save space.
          </p>
